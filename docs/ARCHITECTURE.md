...
- `bookings` tiene contratos y persistencia provisionales, pero no una implementación completa de repositorio.
- mapa, listado, cuentas e impresión todavía no están implementados funcionalmente.
...
- creación transaccional y prevención de doble asignación;
